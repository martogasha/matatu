    ...
    <div class="main-container">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Passanger Listing</li>
            </ol>
            ...
            <div class="row gutters">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="table-container">
                        <div class="t-header">Matatu Listing</div>
                        <div class="table-responsive">
                            <table id="basicExample" class="table custom-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                        <a href="{{url('passanger',$user->id)}}"><button class="btn btn-success">View</button></a>
                                        <button class="btn btn-info view" id="{{$user->id}}" data-toggle="modal" data-target="#editUser">Edit</button>
                                        @if($user->role==1)
                                        @elseif($user->role==3)
                                        @elseif($user->role==0)
                                        @else
        ...
        <form action="{{route('user.edit')}}" method="post">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="customModalTwoLabel">Edit User</h5>
