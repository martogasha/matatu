...
<header class="header">
    <div class="logo-wrapper">
        <a href="index.html" class="logo">
            <img src="{{asset('asset/img/logo.png')}}" alt="Wafi Admin Dashboard" />
        </a>
    ...
    ************* -->
    <div class="main-container">
        ...
        <div class="page-header">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('matatu',$profile->sacco_id)}}">Matatu Listing</a></li>
                <li class="breadcrumb-item active">Matatu Profile</li>
            </ol>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="skillset-container h-320">
                        ...
                        <div class="categories">
                            <span class="badge badge-primary">{{$profile->driver->name}} (Driver)</span>
                           <span class="badge badge-primary">{{$profile->conductor->name}} (Conductor)</span>
                                    ...
                                    <div class="card-bottom pt-3 px-3 mb-2">
                                        <div class="d-flex flex-row justify-content-between text-align-center">
                                            <div class="d-flex flex-column"><span>Balance amount</span>
                                                <p>Ksh <span class="text-white">{{$profile->amount}}</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <ul class="user-messages">
                                    <li class="clearfix">
                                        ...
                                        <div class="delivery-details">
                                            <span class="badge badge-primary">Maxmillan Kibe</span>
                                            <span class="fa fa-star checked"></span>
                                            <span class="fa fa-star checked"></span>
                                            <span class="fa fa-star checked"></span>
                                            <span class="fa fa-star"></span>
