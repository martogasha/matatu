...
<!-- Mirrored from mobilekit.bragherstudio.com/view7/page-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Oct 2020 16:22:01 GMT -->
<head>
    ...
    <div class="login-form">
        ...
        <div class="section mt-2 mb-5">
            <form action="{{route('registerUser')}}" method="post">
                ...
                <div class="form-group boxed">
                    <div class="input-wrapper">
                        <input type="password" class="form-control" name="confirmPassword" id="password2" placeholder="Confirm Password" required>
                        <i class="clear-input">
