...
@include('flash-message');
    <div class="header-large-title">
        <h5 class="title">{{\Illuminate\Support\Facades\Auth::user()->name}}
        </h5>
        <div class="text">
    ...
    <div class="section full mt-3 mb-3">
        <div class="carousel-multiple owl-carousel owl-theme">
            ...
            <a href="{{url('carList',$sacco->id)}}">
            <div class="item">
                <div class="card">
                    <img src="assets/img/sample/photo/supermetro.jpeg" class="card-img-top" alt="image">
                    <div class="card-body pt-2">
                        <h4 class="mb-0">{{$sacco->name}}</h4>
                    </div>
                </div>
            </div>
            </a>
                            ...
                            <div class="col-md-12">
                                <div class="car-card">
                                    <div class="cc-left">
                                        ...
                                        <div class="ccl-text">
                                            <span><i class="fas fa-suitcase"></i><b style="font-weight: bolder">{{$trip->seat}}</b></span>
                                        </div>
                                    </div>
                                    <div class="cc-right">
                                        ...
                                        <div class="ccr-row-d">Price from {{$trip->from}}</div>
                                        <div class="ccr-row-e"><span>Ksh: {{$trip->amount}}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
